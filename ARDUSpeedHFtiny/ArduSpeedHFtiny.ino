/* -----------------------------------------------------------------------
** ArduSpeedHF tiny V0.1 - Speedcontroller for brushed Motors based on 
** HobbyKing 6A UBEC & 10A UBEC ESC (ATmega8) with High Output Frequency
** =======================================================================
**
** Setup:
** ------
...
// System-defines
// -----------------------------
#define ApFET 4                // black wire
#define AnFET 5
#define BpFET A5               // blue wire
#define BnFET A4
#define CpFET A3               // red wire
#define CnFET 8
...
#define lipo_2s_low 250
#define lipo_2s_mid 285
#define lipo_2s_high 325
#define lipo_3s_low 380
#define lipo_3s_mid 425
#define lipo_3s_high 485
...
// -----------------------------
uint8_t helper;
uint8_t pin_array[10] {ApFET, AnFET, BpFET, BnFET, CpFET, CnFET, MuxA, MuxB, MuxC, MuxTemp};
...
void setup() {
    ...
    for(helper = 6; helper < 10; helper++) {                                                // read all analog pins to ensure that the pin
